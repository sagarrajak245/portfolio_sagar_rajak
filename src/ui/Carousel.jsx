...
export default function Carousel({
    ...
    // Precompute rotateY transforms for each carousel item using useTransform outside of map
                    ...
                    return (
                        <motion.div
                            ...
                            className={`relative shrink-0 flex flex-col ${round
                                ...
                                : "items-start justify-between bg-[#0a0015] border border-purple-500 shadow-[0_0_20px_rgba(192,76,255,0.8)] rounded-[12px]"
