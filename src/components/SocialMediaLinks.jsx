...
function SocialMediaLinks() {
  return (
    <div className='m-6 h-auto text-2xl flex gap-4 justify-center items-center'>
      ...
      <a href={"https://drive.google.com/file/d/1eQGtiwthkigWOudRfsdSnGWErzLIU4ge/view?usp=drive_link"} target="_blank" rel="noopener noreferrer" className="text-white hover:text-red-400 transition-colors duration-300" >
