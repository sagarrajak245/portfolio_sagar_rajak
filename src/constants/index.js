...
export const HERO_CONTENT = `I am a passionate full stack developer with a knack for crafting robust and scalable web applications. With  hands-on experience, I have honed my skills in front-end technologies like Reactjs,html,css,javascript,flutter as well as back-end technologies like Node.js, MySQL, PostgreSQL, and MongoDB. express.js,firebase My goal is to leverage my expertise to create innovative solutions that drive business growth and deliver exceptional user experiences.`;

export const ABOUT_TEXT = ` Hi, I'm Sagar Rajak, a second-year AI and Computer Science engineering student with a passion for technology and problem-solving. My journey in the tech world has been both exciting and fulfilling, as I constantly seek to learn and grow in this ever-evolving field.

 I have developed a strong command over the MERN stack (MongoDB, Express.js, React.js, Node.js) and Flutter, allowing me to build robust and scalable web and mobile applications. As a tech enthusiast and self-proclaimed geek, I thrive on learning new things and pushing the boundaries of what I can achieve. Whether it's a new programming language, a challenging project, or a novel AI concept, I'm always up for the challenge.I am meticulous, hardworking, and always eager to collaborate with like-minded individuals.`;
...
description:"It was fun event where you hacve to show your stock market skills.. learnt many things over there about market and got all basics covered ..our team was in top 15.. ",
